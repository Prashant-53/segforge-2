...
import Hero from "../../../assets/Products/Analytics/analyticsHero.webp";
        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-8 max-w-2xl text-md leading-6 text-slate-600">
              Analyze Apache Iceberg tables directly using embedded Apache
              Superset, Trino, and Flink SQL. Build interactive dashboards,
              explore live datasets, and deliver trusted insights without moving
              your data to external BI platforms.
            </p>
          ...
          >
            ...
            <div className="overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-2xl">
              <img src={Hero} alt="Seg Forge Analytics" className="w-full" />
            </div>
          </motion.div>
        </div>
      </div>
