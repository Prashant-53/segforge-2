...
const capabilityGroups = [
  {
    ...
    items: ["Native Apache Superset", "Single Sign-On", "Embedded Workspace"],
  },
  {
    icon: Users,
    title: "Workspace Integration",
    items: ["Shared Dashboards", "Team Collaboration", "Unified Permissions"],
  },
];
...
const supersetFeatures = [
  {
    ...
    title: "Zero-Ops BI",
    description:
      "Apache Superset is fully embedded into Seg Forge, eliminating separate deployments, infrastructure management, upgrades, and ongoing operational maintenance.",
  },
  {
    icon: Lock,
    title: "Secure Access",
    description:
      "Workspace-aware authentication, enterprise RBAC, and centralized identity management ensure every user only accesses the dashboards and datasets they are authorized to view.",
  },
];

const EmbeddedSupersetSection = () => {
  return (
        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-6 text-md leading-6 text-slate-600">
              Seg Forge embeds Apache Superset directly into the platform,
              giving every workspace a production-ready analytics environment
              without separate infrastructure, authentication, or maintenance.
            </p>
...
export default EmbeddedSupersetSection;
