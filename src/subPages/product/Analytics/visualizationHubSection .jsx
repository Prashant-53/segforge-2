...
const capabilityGroups = [
  {
    icon: BarChart3,
    title: "Chart Library",
    items: ["Tables", "Bar Charts", "Line Charts", "Area Charts", "Pie Charts"],
  },
  {
    icon: ChartColumnBig,
...
const visualizationFeatures = [
  {
    ...
    description:
      "Analyze historical trends using calendar heatmaps, rolling metrics, moving averages, and advanced time-series visualizations designed for operational and executive reporting.",
  },
  {
    icon: Filter,
    title: "Interactive Filters",
    description:
      "Build self-service dashboards with drill-downs, cross-filtering, dynamic dimensions, metrics, and interactive controls that enable users to explore data without writing SQL.",
  },
];

const VisualizationHubSection = () => {
  return (
        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-6 text-md leading-6 text-slate-600">
              Create rich visualizations using intuitive drag-and-drop tools.
              Combine datasets, configure metrics, and build executive
              dashboards without writing code.
            </p>
            ...
            <div className="mt-10 rounded-3xl border border-cyan-100 bg-gradient-to-r from-cyan-50 to-white p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-slate-900">
                    Business Users Can Build Powerful Dashboards Without SQL.
                  </h3>

                  <p className="mt-3 leading-7 text-slate-600">
                    Empower analysts and business teams to transform raw
                    enterprise data into interactive dashboards using visual
                    drag-and-drop tools, advanced charting, and powerful
...
export default VisualizationHubSection;
