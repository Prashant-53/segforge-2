...
const capabilityGroups = [
  ...
  },
  {
    ...
    items: ["Add Columns", "Rename Columns", "Drop Columns", "Type Evolution"],
  },
];
...
const icebergFeatures = [
  {
    ...
    description:
      "Continuously optimize storage layouts and partition strategies to improve query performance as workloads evolve over time.",
  },
  {
    icon: History,
    title: "Time Travel",
    description:
      "Query historical snapshots, audit table changes, recover previous versions, and investigate data lineage with complete confidence.",
  },
];
        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-6 text-md leading-6 text-slate-600">
              Manage petabyte-scale datasets with ACID guarantees, schema
              evolution, and time travel—without sacrificing performance,
              scalability, or openness.
            </p>
            ...
            <div className="mt-10 rounded-3xl border border-cyan-100 bg-gradient-to-r from-cyan-50 to-white p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-slate-900">
                    Modern Table Management Without Proprietary Storage.
                  </h3>

                  <p className="mt-3 leading-7 text-slate-600">
                    Build enterprise lakehouse tables using open Apache Iceberg
                    standards while benefiting from transactional consistency,
                    schema evolution, partition optimization, and complete
