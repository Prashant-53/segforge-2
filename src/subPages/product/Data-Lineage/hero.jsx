...
import Hero from "../../../assets/Products/Data-Lineage/hero.webp";
        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-8 max-w-2xl text-md leading-6 text-slate-600">
              Eliminate the black box of data engineering. Seg Forge
              automatically tracks how data flows from operational systems
              through CDC, ETL, notebooks, machine learning, and analytics—all
              the way to your final Apache Iceberg tables with complete
            ...
            <div className="mt-12 flex flex-wrap gap-4">
              ...
              <Link
                to="/docs/user-guide/data-lineage"
          ...
          >
            ...
            <div className="overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-2xl">
              <img src={Hero} alt="Seg Forge Data Lineage" className="w-full" />
            </div>
          </motion.div>
        </div>
      </div>
