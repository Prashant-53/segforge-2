...
import InteractiveGraph from "../../../assets/Products/Data-Lineage/interactivelinegrp.webp";
...
const lineageFeatures = [
  {
    icon: ZoomIn,
    title: "Interactive Exploration",
    description:
      "Navigate massive enterprise lineage graphs using zoom, filtering, search, and graph isolation to quickly understand dependencies across business domains, pipelines, and datasets.",
  },
  {
    icon: Sparkles,
    title: "Automatic Discovery",
    description:
      "Lineage is generated automatically as pipelines execute. Every transformation, notebook, streaming job, and analytics asset is continuously mapped without manual documentation.",
  },
];

const InteractiveLineageSection = () => {
  return (
        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-6 text-md leading-6 text-slate-600">
              Navigate complete upstream and downstream dependencies through an
              interactive lineage graph that automatically maps datasets,
              pipelines, notebooks, streaming jobs, and analytics assets.
            </p>
          ...
          >
            ...
            <div className="overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-2xl">
              <img
                src={InteractiveGraph}
                alt="Interactive Lineage Graph"
                className="w-full"
              />
            </div>
          </motion.div>
...
export default InteractiveLineageSection;
