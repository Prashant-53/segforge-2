...
import ZeroCopyBranch from "../../../assets/Products/Lakehouse-Governance/zerocopy.webp";
...
const branchingFeatures = [
  {
    icon: Database,
    title: "Zero Storage Duplication",
    description:
      "Create isolated branches of entire catalogs instantly without copying underlying Apache Iceberg data. Teams can develop, validate, and iterate without increasing storage costs.",
  },
  {
    icon: ShieldCheck,
    title: "Production Safety",
    description:
      "Experiment with schema updates, transformations, and new datasets while production analytics continue uninterrupted. Only validated changes are promoted into trusted environments.",
  },
];

const ZeroCopyBranchingSection = () => {
  return (
        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-6 text-md leading-6 text-slate-600">
              Create isolated branches of your lakehouse without duplicating
              data. Test schema changes, validate transformations, and promote
              only verified results into production.
            </p>
...
export default ZeroCopyBranchingSection;
