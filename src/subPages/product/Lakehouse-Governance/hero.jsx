...
import Hero from "../../../assets/Products/Lakehouse-Governance/lakehouseHero.webp";
        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-8 max-w-2xl text-md leading-6 text-slate-600">
              Manage enterprise data with Git-inspired version control, open
              table formats, and complete historical traceability. Built on
              Apache Iceberg and Apache Nessie, Seg Forge enables teams to
              govern, evolve, and recover data with confidence while maintaining
              complete ownership of their infrastructure.
            </p>
          ...
          >
            ...
            <div className="overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-2xl">
              <img
                src={Hero}
                alt="Seg Forge Lakehouse Governance"
                className="w-full"
              />
            </div>
          </motion.div>
