        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-slate-900 leading-[1.05]">
              Turn specialists into
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-600">
                full-stack data practitioners.
              </span>
            </h1>

            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Equip engineers, analysts, scientists, and operators with the
              skills needed to build, govern, and scale modern data platforms.
              <br />
              <br />
              Reduce learning curves, accelerate adoption, and enable teams to
              extract maximum value from SegForge.
            </p>
