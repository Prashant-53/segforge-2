...
const deliverables = [
  ...
  "Governance Review",
  "FinOps Optimization Plan",
];

const ArchitectureReviewCTA = () => {
  return (
          ...
          <div className="relative z-10">
            ...
            <div className="text-center">
              ...
              <h2 className="text-3xl lg:text-5xl font-bold text-slate-900 leading-tight max-w-4xl mx-auto">
                Receive a roadmap for a
                <br />
                more resilient platform.
              </h2>

              <p className="mt-6 text-slate-600 text-lg leading-relaxed max-w-2xl mx-auto">
                Every Architecture Review includes actionable recommendations,
                performance tuning guidance, security hardening plans, and
...
export default ArchitectureReviewCTA;
