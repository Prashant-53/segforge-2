...
import SovereigntyImg from "../../../assets/Solutions/Telecom/sovereignty.webp";
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-50 text-cyan-700 text-sm font-medium mb-6">
              ...
              Telecom Data Sovereignty
            </div>

            <h2 className="text-2xl lg:text-4xl font-bold text-slate-900 leading-[1.05]">
              Keep telecom intelligence
              <br />
              within your control.
            </h2>

            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Deploy SegForge within private infrastructure while maintaining
              complete ownership of subscriber data, network telemetry, and
              operational intelligence.
              <br />
              <br />
              Protect sensitive information while enabling secure collaboration
...
export default TelecomSovereignty;
