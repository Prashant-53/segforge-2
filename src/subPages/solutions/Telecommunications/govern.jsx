...
const callouts = [
  ...
  "Subscriber PII Tracking",
  "Regulatory Reporting",
  "Audit History",
];

const TelecomGovernance = () => {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Maintain compliance while understanding exactly how subscriber
              information moves across operational, analytical, and
              customer-facing systems.
              <br />
              <br />
              Provide complete auditability, lineage visibility, and governance
              controls for regulatory reporting, privacy requirements, and
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={GovernanceImg}
                alt="Telecom Governance Architecture"
