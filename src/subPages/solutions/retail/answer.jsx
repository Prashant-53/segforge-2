        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              SegForge unifies ingestion, transformation, analytics, governance,
              and machine learning into a single operating model.
              <br />
              <br />
              Retail teams gain a consistent view of customers, inventory, and
              operations without stitching together multiple tools.
            </p>
