        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={FrameworkImg}
                alt="Deployment Excellence Framework"
          ...
          >
            ...
            <h2 className="text-4xl lg:text-4xl font-bold text-slate-900 leading-[1.05]">
              One framework for deployment,
              <br />
              scaling, and operations.
            </h2>

            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Deploy, configure, scale, and manage modern streaming and
              lakehouse infrastructure using a unified deployment methodology
              built for enterprise workloads.
              <br />
              <br />
              Standardize infrastructure provisioning, operational practices,
              security controls, and lifecycle management across every
              environment.
            </p>
