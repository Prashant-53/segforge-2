        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={ResilienceImg}
                alt="Resilience and Scaling Architecture"
          ...
          >
            ...
            <h2 className="text-4xl lg:text-4xl font-bold text-slate-900 leading-[1.05]">
              Scale confidently from proof
              <br />
              of concept to production.
            </h2>

            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Build highly available deployments that automatically adapt to
              changing workloads while maintaining operational reliability.
              <br />
              <br />
              Choose between self-hosted control or managed cloud simplicity
              based on your organization's security, compliance, and operational
              requirements.
            </p>
