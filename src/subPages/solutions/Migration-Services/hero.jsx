        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Migrate from legacy databases, warehouses, and fragmented data
              stacks to a unified open-standard lakehouse platform.
              <br />
              <br />
              Reduce operational complexity, eliminate vendor lock-in, and
              accelerate analytics, machine learning, and governance from day
              one.
            </p>
