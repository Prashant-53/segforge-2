...
import ChallengeImg from "../../../assets/Solutions/Migration/challenge.webp";
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-4xl font-bold text-slate-900 leading-[1.05]">
              Organizations spend too much time maintaining data stacks instead
              of creating value.
            </h2>

            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Legacy databases, disconnected analytics tools, and point
              solutions increase operational overhead, infrastructure costs, and
              migration risk.
              <br />
              <br />
              Every additional platform creates more complexity, governance
              gaps, and long-term technical debt that slows innovation and
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={ChallengeImg}
                alt="Fragmented Legacy Data Stack"
...
export default MigrationChallenge;
