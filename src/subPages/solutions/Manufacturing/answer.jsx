        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={PlatformImg}
                alt="SegForge Manufacturing Platform"
          ...
          >
            ...
            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              SegForge unifies industrial ingestion, transformation, analytics,
              governance, and machine learning into a single operating model.
              <br />
              <br />
              Manufacturing teams gain real-time visibility across production,
              quality, maintenance, and supply chain operations without
