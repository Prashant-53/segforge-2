        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-2xl lg:text-4xl font-bold text-slate-900 leading-[1.05]">
              Manufacturers spend too much time connecting systems instead of
              optimizing production.
            </h2>

            <p className="mt-4 text-md text-slate-600 leading-relaxed max-w-xl">
              Critical operational data is often spread across MES platforms,
              ERP systems, industrial databases, machine telemetry streams, and
              analytics environments.
              <br />
              <br />
              Disconnected systems create blind spots that impact efficiency,
              maintenance planning, and product quality.
            </p>
