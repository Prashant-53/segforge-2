...
import ChallengeImg from "../../../assets/Solutions/partner-Ecosystem/challenge.webp";
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-4xl font-bold text-slate-900 leading-[1.05]">
              Most organizations spend too
              <br />
              much time connecting tools
              <br />
              instead of creating value.
            </h2>

            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Modern data environments often rely on dozens of disconnected
              platforms for ingestion, storage, governance, analytics, and
              reporting.
              <br />
              <br />
              Every additional integration increases maintenance overhead,
              operational complexity, and long-term vendor dependency.
            </p>
