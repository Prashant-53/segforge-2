        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-slate-900 leading-[1.05]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-600">
                Innovate without lock-in.
              </span>
            </h1>

            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Connect SegForge with the analytics, governance, storage, and
              cloud platforms your teams already use.
              <br />
              <br />
              Build on open standards while maintaining complete control over
              your data, infrastructure, and future architecture decisions.
            </p>
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={IntegrationsHeroImg}
                alt="SegForge Open Ecosystem"
