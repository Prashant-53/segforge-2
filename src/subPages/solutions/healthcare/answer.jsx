        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={AnswerImg}
                alt="SegForge Healthcare Platform"
          ...
          >
            ...
            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              SegForge brings data integration, interoperability, analytics,
              governance, and machine learning together within a single
              operating model.
              <br />
              <br />
              Healthcare teams can move from data collection to clinical insight
              without managing multiple disconnected platforms.
            </p>
            ...
            <div className="mt-12 border-y border-slate-200 py-8">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                {platformStats.map((stat) => (
                  <div key={stat.label}>
                    <div className="text-3xl lg:text-2xl font-bold text-slate-900">
                      {stat.value}
                    </div>
