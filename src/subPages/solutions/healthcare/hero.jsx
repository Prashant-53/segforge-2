        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="mt-4 text-md text-slate-600 leading-relaxed max-w-xl">
              Unify clinical, operational, and research data on a single
              platform built for modern healthcare and life sciences.
            </p>
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={HeroImg}
                alt="Healthcare Data Platform Architecture"
