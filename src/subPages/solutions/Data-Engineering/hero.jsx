        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-slate-900 leading-[1.05]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-600">
                pipelines without the operational burden.
              </span>
            </h1>

            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Unify ingestion, transformation, orchestration, and lakehouse
              operations on a platform designed for modern data engineering
              teams.
              <br />
              <br />
              Reduce pipeline maintenance, accelerate delivery, and move from
              fragmented tooling to real-time data products powered by Apache
              Flink and Iceberg.
            </p>
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={DataEngineeringHeroImg}
                alt="Data Engineering Platform"
