...
const ResilientOrchestrationMonitoring = () => {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={MonitoringImg}
                alt="Resilient Orchestration and Monitoring"
          ...
          >
            ...
            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Monitor pipelines, streaming infrastructure, storage, and
              governance from a unified operational view.
              <br />
              <br />
              Track dependencies, identify bottlenecks, and resolve issues
              before they impact downstream consumers or business-critical
              workloads.
            </p>
