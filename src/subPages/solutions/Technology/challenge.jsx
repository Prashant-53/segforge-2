        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-2xl lg:text-4xl font-bold text-slate-900 leading-[1.05]">
              Technology teams spend too much time managing infrastructure
              instead of building products.
            </h2>

            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Engineering teams often rely on separate tools for data ingestion,
              analytics, machine learning, governance, and monitoring.
              <br />
              <br />
              The result is increased operational overhead, slower product
              development, and growing infrastructure costs.
            </p>
