...
import PlatformImg from "../../../assets/Solutions/Technology/platform.webp";
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={PlatformImg}
                alt="SegForge Product Data Platform"
          ...
          >
            ...
            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              SegForge unifies ingestion, analytics, machine learning,
              governance, and infrastructure management into a single operating
              model.
              <br />
              <br />
              Build, deploy, and scale data products without stitching together
              multiple vendors or maintaining fragmented infrastructure stacks.
            </p>
