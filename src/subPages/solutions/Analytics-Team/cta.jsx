          ...
          <div className="relative z-10">
            ...
            <div className="text-center">
              ...
              <h2 className="text-3xl lg:text-5xl font-bold text-slate-900 leading-tight max-w-4xl mx-auto">
                ...
                <br />
                and more time delivering insight.
              </h2>

              <p className="mt-6 text-slate-600 text-lg leading-relaxed max-w-2xl mx-auto">
                Empower analysts with direct access to governed data, real-time
                exploration tools, and business intelligence capabilities that
            ...
            <div className="mt-12 border-y border-slate-200 py-8">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                <div>
                  ...
                  <div className="mt-2 text-sm text-slate-500">Insights</div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-2 text-sm text-slate-500">Analytics</div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-2 text-sm text-slate-500">Exploration</div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-2 text-sm text-slate-500">Decisions</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-slate-200">
              <div className="flex flex-wrap justify-center gap-8 text-sm text-slate-500">
                ...
                <span>Flink SQL & Trino</span>
                <span>Governed Self-Service Analytics</span>
              </div>
            </div>
          </div>
        </div>
