        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <img
                src={BIImg}
                alt="Native Business Intelligence"
          ...
          >
            ...
            <p className="mt-8 text-md text-slate-600 leading-relaxed max-w-xl">
              Create interactive dashboards and analytical applications without
              moving data into separate BI systems.
              <br />
              <br />
              Leverage Apache Superset and SQL Lab to transform exploration into
              business-ready reporting while maintaining a single source of
              truth.
            </p>
