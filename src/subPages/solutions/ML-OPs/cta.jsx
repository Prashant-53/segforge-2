          ...
          <div className="relative z-10">
            ...
            <div className="text-center">
              ...
              <p className="mt-6 text-slate-600 text-lg leading-relaxed max-w-2xl mx-auto">
                Unify feature engineering, model development, deployment,
                monitoring, and governance on a platform designed to accelerate
                machine learning outcomes.
              </p>
            </div>
            ...
            <div className="mt-12 border-y border-slate-200 py-8">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                <div>
                  ...
                  <div className="mt-2 text-sm text-slate-500">Deployment</div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-2 text-sm text-slate-500">AI Models</div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-2 text-sm text-slate-500">MLOps</div>
                </div>
              </div>
            </div>
...
export default MachineLearningCTA;
